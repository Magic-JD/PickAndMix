...
const resources = {
    en: {
        translation: {
            ...
            "game-rules": "Each turn make an anagram of the previous word and change one letter. The two words will change every day, and you need a maximum of 5 steps to get from the first to the final word.",
    ...
    id: {
        translation: {
            ...
            "game-rules": "Setiap giliran, buatlah anagram dari kata sebelumnya dan ubah satu huruf. Dua kata akan berubah setiap hari, dan Anda memerlukan maksimum 5 langkah untuk berpindah dari kata pertama ke kata akhir.",
